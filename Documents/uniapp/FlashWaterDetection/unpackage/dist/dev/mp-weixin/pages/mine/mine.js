...
var _mine = _interopRequireDefault(__webpack_require__(/*! ./pages/mine/mine.vue */ 93));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...

{
  ...
  (0, _vuex.mapActions)(['authUserInfo'])), {}, {
    ...
    AdminContro: function AdminContro(hasrule) {
      if (hasrule == 1) {
        this.show = true;
      } else {
        uni.showToast({
